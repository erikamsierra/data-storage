# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-07-03 23:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='data_storage.Skill')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='athlete',
            name='championships',
            field=models.ManyToManyField(related_name='athletes', to='data_storage.Championship'),
        ),
        migrations.AddField(
            model_name='athlete',
            name='skills',
            field=models.ManyToManyField(related_name='athletes', to='data_storage.Skill'),
        ),
    ]
